# Chute settings and setup

The [README](README.md) says what Chute is. This is everything else: what the
optional parts need, and every key `config.json` takes.
...
summaries and the security limits are JSON only; see `examples/`.
